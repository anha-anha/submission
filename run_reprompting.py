...
# args
parser = argparse.ArgumentParser(description="attack", parents=[gs_parser, tr_parser])

parser.add_argument("--out_dir", type=str, default="out/reprompting/")
