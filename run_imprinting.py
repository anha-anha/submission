...
# args
parser = argparse.ArgumentParser(description="imprint", parents=[gs_parser, tr_parser])

parser.add_argument("--out_dir", type=str, default="out/imprinting/")
...
pipe_attacker, forward_scheduler, inverse_scheduler = imprint_utils.load_pipe(device=DEVICE)

# pipe_provider used by the target model (SD2.1, SDXL, PixArt, FLUX)
